...
public class HistoricalGainQuote extends HistoricalQuote {

	private double gainLossForPeriod;

	public HistoricalGainQuote(HistoricalQuote q0, HistoricalQuote q1) {
		...
		this.gainLossForPeriod = gl < 0 ? 0 : gl;
